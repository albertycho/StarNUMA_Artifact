...
public:
  ...
  uint64_t lat_hist[NUM_CPUS][100]={0};
  uint64_t mlp_hist[NUM_CPUS][300]={0};

  uint64_t n_hit_but_block_transfer=0;
  uint64_t consecutive_blocks_from_migration=0;
  PACKET blocking_packet;
